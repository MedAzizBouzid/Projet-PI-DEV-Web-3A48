...
return [
    ...
    'Display_Activite' => [[], ['_controller' => 'App\\Controller\\JSONActiviteController::Allmyactivities'], [], [['text', '/Displayhome']], [], [], []],
    'Add_Activite' => [[], ['_controller' => 'App\\Controller\\JSONActiviteController::addStudentJSON'], [], [['text', '/AddActivite']], [], [], []],
    'activites' => [[], ['_controller' => 'App\\Controller\\JsonController::Allmyactivities'], [], [['text', '/Display_test']], [], [], []],
    'addStudentJSON' => [[], ['_controller' => 'App\\Controller\\JsonController::addStudentJSON'], [], [['text', '/addTestJSON']], [], [], []],
    'show_activite' => [['id'], ['_controller' => 'App\\Controller\\JsonController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/activites']], [], [], []],
    'update_activite' => [['id'], ['_controller' => 'App\\Controller\\JsonController::update'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/Edit_activites']], [], [], []],
    'delete_activite' => [['id'], ['_controller' => 'App\\Controller\\JsonController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/Delete_activites']], [], [], []],
    ...
    'app_map_index' => [[], ['_controller' => 'App\\Controller\\MapController::index'], [], [['text', '/map/displayMap']], [], [], []],
    'app_Map_new' => [['id'], ['_controller' => 'App\\Controller\\MapController::new'], [], [['text', '/Add_MapToSSalle'], ['variable', '/', '[^/]++', 'id', true], ['text', '/map']], [], [], []],
    ...
    'app_salle_j_son' => [[], ['_controller' => 'App\\Controller\\SalleJSonController::index'], [], [['text', '/salle/j/son']], [], [], []],
    'All_Salle' => [[], ['_controller' => 'App\\Controller\\SalleJSonController::getAllsalle'], [], [['text', '/AllSalle']], [], [], []],
    'addSalleJSON' => [[], ['_controller' => 'App\\Controller\\SalleJSonController::addStudentJSON'], [], [['text', '/addSalleJSON']], [], [], []],
    'map' => [[], ['_controller' => 'App\\Controller\\TraitementController::map'], [], [['text', '/heeeeey']], [], [], []],
    ...
    'contact' => [[], ['_controller' => 'App\\Controller\\TraitementController::contact'], [], [['text', '/contact']], [], [], []],
    'afficher_carte' => [[], ['_controller' => 'App\\Controller\\MapController::afficherCarte'], [], [['text', '/carte']], [], [], []],
];
