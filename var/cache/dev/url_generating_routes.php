...
return [
    ...
    'app_cart_test' => [['id'], ['_controller' => 'App\\Controller\\CartController::test'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/test']], [], [], []],
    'app_cart_update' => [['id'], ['_controller' => 'App\\Controller\\CartController::update'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/update']], [], [], []],
    'app_cart_add' => [['id'], ['_controller' => 'App\\Controller\\CartController::add'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/add']], [], [], []],
    ...
    'app_categorie_delete' => [['id'], ['_controller' => 'App\\Controller\\CategorieController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/categorie/delete']], [], [], []],
    ...
    'app_commande_pdf' => [['id'], ['_controller' => 'App\\Controller\\CommandeController::generatePdfAction'], [], [['text', '/pdf'], ['variable', '/', '[^/]++', 'id', true], ['text', '/commande']], [], [], []],
    ...
    'app_produit_index_front' => [[], ['_controller' => 'App\\Controller\\ProduitController::AffichageFrontPaginated'], [], [['text', '/produit/show/front']], [], [], []],
