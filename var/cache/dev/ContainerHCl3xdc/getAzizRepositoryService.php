 ...
 */
class getAzizRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AzizRepository' shared autowired service.
     *
     * @return \App\Repository\AzizRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AzizRepository.php';

        return $container->privates['App\\Repository\\AzizRepository'] = new \App\Repository\AzizRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
