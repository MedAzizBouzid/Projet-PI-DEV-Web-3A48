...
use App\Entity\Twig_Loader_Filesystem;
use App\Entity\User;
...
class CartController extends AbstractController
{
    ...
    public function addPanier(UserRepository $UR, PanierRepository $PR, CommandeRepository $cr, LignePanierRepository $LPRepository,$id): Response
    {
        //integration dhia
        $client= new User();
    ...
    public function panierShow(SessionInterface $session, UserRepository $UR, PanierRepository $PR,$id): Response
    {
